...
export default function CourseGradeSelect({ course, onGradeChange }: CourseGradeSelectProps) {
  ...
  return (
    <div className="flex flex-col sm:flex-row sm:items-center justify-between py-2 md:py-3 border-b border-gray-800 gap-2">
      ...
      >
        <SelectTrigger className="w-[100px] md:w-[120px] bg-gray-900 border-gray-700 text-xs md:text-sm h-8 md:h-10">
