  ...
  return (
    <div className="p-2 w-full">
      <Card className="w-full max-w-2xl mx-auto bg-gray-900 border-gray-800 shadow-xl">
        ...
        <CardContent className="pt-4 md:pt-6">
          <div className="flex flex-col sm:flex-row items-start sm:items-center justify-between mb-4 gap-2 sm:gap-0">
            <div className="flex flex-wrap gap-2 items-center mb-2 sm:mb-0">
              ...
              {cgpa !== null && (
                <Badge className="px-2 py-1 md:px-3 bg-gray-800 hover:bg-gray-800 text-gray-100 text-xs md:text-sm">
                  CGPA: {cgpa.toFixed(2)}
                </Badge>
              )}
            </div>
        ...
        <div className="text-center py-3 text-sm text-gray-500 border-t border-gray-800">
